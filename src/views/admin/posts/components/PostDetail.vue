    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        ...
        <el-form-item style="margin-bottom: 40px;" label-width="70px" label="Summary:">
          <el-input v-model="postForm.content_short" :rows="1" type="textarea" class="post-textarea" autosize
            placeholder="Please enter the content" />
          <span v-show="contentShortLength" class="word-counter">{{ contentShortLength }}words</span>
        </el-form-item>

        <el-form-item prop="content" style="margin-bottom: 30px;background: red;">
          <!-- <Tinymce ref="editor" v-model="postForm.content" :height="400" /> -->
          <textarea ref="editor" style="width: 100%;" v-model="postForm.content" rows="10"></textarea>
        </el-form-item>
...
import { fetchPost } from '@/api/admin/posts'
import { searchUser } from '@/api/admin/remote-search'
import Warning from './Warning'
import { CommentDropdown, PlatformDropdown, SourceUrlDropdown } from './Dropdown'

import { createPost } from '@/api/admin/posts'
...
export default {
  ...
  methods: {
    ...
    async draftForm() {
      ...
      const resp = await createPost(this.postForm)
